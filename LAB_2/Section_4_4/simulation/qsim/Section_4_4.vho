...
ARCHITECTURE structure OF Two_bits_adder IS
...
SIGNAL \component_1|component_1|Sum~combout\ : std_logic;
SIGNAL \SW[3]~input_o\ : std_logic;
SIGNAL \SW[1]~input_o\ : std_logic;
SIGNAL \component_2|component_2|Sum~combout\ : std_logic;
SIGNAL \component_2|cout~combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \component_1|component_1|Sum~combout\,
	devoe => ww_devoe,
	o => ww_LEDR(0));
...
-- pragma translate_on
PORT MAP (
	i => \component_2|component_2|Sum~combout\,
	devoe => ww_devoe,
	o => ww_LEDR(1));
...
\component_1|component_1|Sum\ : cyclonev_lcell_comb
-- Equation(s):
-- \component_1|component_1|Sum~combout\ = ( !\SW[0]~input_o\ & ( \SW[2]~input_o\ ) ) # ( \SW[0]~input_o\ & ( !\SW[2]~input_o\ ) )
...
PORT MAP (
	...
	combout => \component_1|component_1|Sum~combout\);
...
-- Location: MLABCELL_X19_Y1_N45
\component_2|component_2|Sum\ : cyclonev_lcell_comb
-- Equation(s):
-- \component_2|component_2|Sum~combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ $ (\SW[2]~input_o\) ) ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[3]~input_o\ 
...
PORT MAP (
	...
	combout => \component_2|component_2|Sum~combout\);

-- Location: MLABCELL_X19_Y1_N12
\component_2|cout\ : cyclonev_lcell_comb
-- Equation(s):
-- \component_2|cout~combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ & ( (\SW[3]~input_o\) # (\SW[2]~input_o\) ) ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( \SW[3]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( (\SW[2]~input_o\ & 
-- \SW[3]~input_o\) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_SW[0]~input_o\,
	dataf => \ALT_INV_SW[1]~input_o\,
	combout => \component_2|cout~combout\);
